//! SP1 guest program for the GSX L2 STM (Track G G1 /
//! Phase 1.1 follow-up, #82).
//!
//! ## Contract
//!
//! - **Reads** a `gsx_l2_stm::BatchInput` from SP1 stdin
...
//!   `gsx_l2_stm::execute_batch` the native host runs. Any
...
//!   `gsx_l2_verifier_precompile::public_inputs::*` byte-for-
...
//! ## Build
//!
//! From `crates/gsx-l2-stm/program/`:
//!
//! ```sh
//! cargo prove build --output-directory ../elf
//! ```
//!
//! Produces `../elf/gsx-l2-stm-program` (the ELF) that the
...
use gsx_l2_stm::{execute_batch, to_public_inputs, BatchInput};
...
pub fn main() {
    ...
    // verifier (`gsx-l2-verifier-precompile::verify_l2_batch`)
