//! gsx-ltp — Lattice Transfer Protocol integration.
//!
//! Implements §10 of the *GSX DAG Layer 1* paper. Companion paper:
//! *Lattice Transfer Protocol* (`gsx-papers/papers/ltp`).
//!
