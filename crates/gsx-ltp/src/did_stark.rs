...
use gsx_crypto::{hash, mldsa};
use gsx_precompiles::{Did, DidDocument, VerificationMethodId, VerificationRelationship};
...
impl DidRotationStatement {
    /// Canonical SHA3-256 digest with the `GSX-DID-STARK-V1` domain
...
mod tests {
    ...
    use gsx_precompiles::{KeyAlgorithm, VerificationMethod};
