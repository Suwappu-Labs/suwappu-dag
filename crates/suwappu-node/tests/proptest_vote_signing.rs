...
//! -p suwappu-node --release`.

use suwappu_consensus::{CertHash, Vote};
use suwappu_crypto::mldsa;
use suwappu_node::{sign_vote, verify_vote_signature};
use suwappu_validator::{ValidatorMember, ValidatorRegistry, VALIDATOR_STAKE_THRESHOLD_SUWAPPU};
    ...
    for i in 0..n {
        ...
        registry
            .admit(ValidatorMember {
                id: i,
                stake_suwappu: VALIDATOR_STAKE_THRESHOLD_SUWAPPU,
