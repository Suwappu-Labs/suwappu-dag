...
//!
//! Every consensus state transition emits one NDJSON line to disk. `suwappu-metrics`
...
/// so the JSON-RPC `suwappu_subscribeEvents` WebSocket can stream live without
