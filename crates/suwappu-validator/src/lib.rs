//! suwappu-validator — Validator Ring (Proof-of-Stake).
//!
...
/// Stake unit, in canonical SUWAPPU amounts. Sized for the 50,000-SUWAPPU × 500-
/// validator envelope without saturation.
pub type Stake = u128;

/// Genesis stake threshold per validator, in SUWAPPU.
pub const VALIDATOR_STAKE_THRESHOLD_SUWAPPU: u128 = 25_000;
...
mod tests {
    ...
    fn stake_threshold_matches_paper() {
        assert_eq!(VALIDATOR_STAKE_THRESHOLD_SUWAPPU, 25_000);
    }
}
