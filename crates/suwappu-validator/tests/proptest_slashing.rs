...
proptest! {
    ...
    fn equivocation_proof_slashes(
        ...
        let stake = AUTHORITY_STAKE_THRESHOLD_SUWAPPU + payload_seed % 10_000;
    ...
    fn validator_double_vote_slashes_30_percent(
        ...
        let stake = VALIDATOR_STAKE_THRESHOLD_SUWAPPU * stake_units;
    ...
    fn slashing_is_idempotent(
        ...
        for i in 0..n_validators {
            val_reg.admit(ValidatorMember {
                id: i,
                stake_suwappu: VALIDATOR_STAKE_THRESHOLD_SUWAPPU * 10,
            }).unwrap();
        }
