...
pub const VALIDATOR_UNBONDING_REGISTRY_DOMAIN: &[u8] = b"suwappu-validator-unbonding-registry-v1";

/// Domain tag for the DA-anchor registry (Track G G3.3). Stores
/// `BLAKE3("suwappu-da-blob-v1" || da_blob)` keyed by
...
/// IQ-007).
pub const DA_ANCHOR_REGISTRY_DOMAIN: &[u8] = b"suwappu-da-anchor-registry-v1";
