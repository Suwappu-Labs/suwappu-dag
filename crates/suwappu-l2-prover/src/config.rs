...
//! writes the file via cloud-init (matching the suwappu-l2-sequencer-daemon
...
pub struct ProverConfig {
    ...
    /// suwappu-node's metrics posture.
...
mod tests {
    ...
    fn minimal_toml() -> &'static str {
        r#"
sequencer_rpc_url = "https://rpc.testnet.suwappu.globalsettlement.com"
"#
    }
...
"#;
    ...
    fn load_from_missing_path_surfaces_io_error() {
        let err = ProverConfig::load_from_path("/tmp/suwappu-l2-prover-config-does-not-exist.toml")
            .unwrap_err();
