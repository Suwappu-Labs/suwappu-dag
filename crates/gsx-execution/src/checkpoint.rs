...
use gsx_authority::{AuthorityId, AuthorityRegistry};
...
impl Checkpoint {
    ...
    ///
    /// Encoding: `BLAKE3("GSX-CHECKPOINT-V1" || height (8 BE) || round (8 BE)
...
) -> Result<CheckpointSignature, gsx_crypto::CryptoError> {
