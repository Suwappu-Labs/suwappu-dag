...
//! `gsx_consensus::finalize` (DAG-S4) → the linearized certificate
...
//! `gsx-consensus` and is consumed by this adapter once the gsx-db tag
//! is cut.

use gsx_consensus::Round;
...
/// The gsx-db bundle abstraction (paper §7.3) provides full atomic
