//! suwappu-authority — Authority Ring (Proof-of-Authority).
//!
//! Implements §5.1 of the *Suwappu DAG Layer 1* paper:
//!
...
//! - 100,000 SUWAPPU stake threshold per member
...
/// Stake threshold per Authority Node, in SUWAPPU.
pub const AUTHORITY_STAKE_THRESHOLD_SUWAPPU: u64 = 100_000;
...
mod tests {
    ...
    fn stake_threshold_matches_paper() {
        assert_eq!(AUTHORITY_STAKE_THRESHOLD_SUWAPPU, 100_000);
    }
}
