...
//! `suwappu_authority::slash_authority` primitive for each signer.

use suwappu_authority::{slash_authority, AuthorityRegistry, AuthoritySlash};
...
mod tests {
    ...
    fn every_seated_signer_is_expelled() {
        ...
        assert_eq!(
            ...
            4 * AUTHORITY_STAKE_THRESHOLD_SUWAPPU,
        );
