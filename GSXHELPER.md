...
`CLAUDE.md` stub (`@./GSXHELPER.md`), so Claude Code auto-loads it at the start
...
- This `GSXHELPER.md` (sprint backlog section below)
...
1. Read this `GSXHELPER.md` (already loaded via the root `CLAUDE.md` import).
...
Treat changes to `GSXHELPER.md` like any other PR — review and merge.
