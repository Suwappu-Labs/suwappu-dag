...
//   - https://rpc.devnet.suwappu.globalsettlement.com → suwappu_getEpoch
//     (chain head + last-commit-timestamp via the explorer's lens).
//   - https://faucet.devnet.suwappu.globalsettlement.com/health → 200 = up.
//
...
// public proxy at status-api.devnet.suwappu.globalsettlement.com (G6's
...
const RPC_URL    = "https://rpc.devnet.suwappu.globalsettlement.com";
const FAUCET_URL = "https://faucet.devnet.suwappu.globalsettlement.com";
const POLL_MS    = 5000;
