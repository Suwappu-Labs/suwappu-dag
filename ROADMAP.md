...
For day-to-day work see [`SUWAPPUHELPER.md`](./SUWAPPUHELPER.md) (sprint backlog table)
...
- v8 academic paper ratified in
  `suwappu/suwappu-papers/papers/dag-l1` (`suwappu_dag_l1_academic_v7.pdf`).
...
- File a [discussion](https://github.com/suwappu/suwappu-dag/discussions)
  for any phase-level proposal.
- File an [issue](https://github.com/suwappu/suwappu-dag/issues)
