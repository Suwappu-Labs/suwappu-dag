...
output "validators" {
  description = "Map of region_label -> { authority_id, public_ip } for all seven regions."
  value = {
    ...
    "af-south-1"     = { authority_id = module.af_south_1.authority_id, public_ip = module.af_south_1.public_ip }
  }
}
