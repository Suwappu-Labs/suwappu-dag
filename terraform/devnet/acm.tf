...
#
# Single wildcard cert: `*.devnet.gsx.globalsettlement.com` covers
...
resource "aws_acm_certificate" "wildcard" {
  ...
  subject_alternative_names = [
    # Apex-of-subdomain (e.g. `devnet.gsx.globalsettlement.com`)
...
output "wildcard_cert_arn" {
  description = "ACM certificate ARN covering *.devnet.gsx.globalsettlement.com. Consumed by alb.tf + G7 explorer.tf + G8 status.tf."
