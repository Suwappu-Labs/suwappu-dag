...
- [ ] Foundation publishes the announcement on:
  ...
  - `https://blog.suwappu.globalsettlement.com/announcements/`
...
- [ ] L1 state snapshot: last committed checkpoint's full
  ...
  `https://testnet.suwappu.globalsettlement.com/snapshots/`
...
- [ ] All 7 seed validators receive the new genesis manifest
  via the existing
  `https://testnet.suwappu.globalsettlement.com/genesis.toml`
...
>
> The Suwappu foundation will perform a
...
>   See [docs/testnet/POINTS.md](https://github.com/suwappu/suwappu-dag/blob/main/docs/testnet/POINTS.md).
...
> `https://testnet.suwappu.globalsettlement.com/genesis-<re-genesis-id>.toml`.
>
> ### Operator action
>
...
>    `curl -fsS https://testnet.suwappu.globalsettlement.com/genesis-<re-genesis-id>.toml > /etc/suwappu/genesis.toml`
>    `curl -fsS https://testnet.suwappu.globalsettlement.com/peers-<re-genesis-id>.txt > /etc/suwappu/peers.txt`
...
>    `https://explorer.testnet.suwappu.globalsettlement.com/validator/<your-id>`
>
