...
- `docs/iq/IQ-001-quorum-formula.md` — ratified 2026-05-14 ([suwappu-papers#1](https://github.com/Suwappu-Labs/suwappu-papers/pull/1)).
- `docs/iq/IQ-002-indirect-commit.md` — ratified 2026-05-14 ([suwappu-papers#1](https://github.com/Suwappu-Labs/suwappu-papers/pull/1)).
- `docs/iq/IQ-003-fast-path-architecture.md` — handler wired; K-binding gap.
- `docs/iq/IQ-004-decide-slot-orphan-window.md` — pending sign-off; tracking [#45](https://github.com/Suwappu-Labs/suwappu-dag/issues/45).
