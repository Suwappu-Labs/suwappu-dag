...
- ~~**Per-IP JSON-RPC rate limit**~~ — **shipped F1 on 2026-05-15**
  ([PR #67](https://github.com/suwappu/suwappu-dag/pull/67)):
...
- ~~**Indexer backfill**~~ — **shipped F2 on 2026-05-15**
  ([PR #68](https://github.com/suwappu/suwappu-dag/pull/68)):
...
- **`phase_g_admit_and_eject` flake** — F3 (shipped 2026-05-15,
  [PR #69](https://github.com/suwappu/suwappu-dag/pull/69))
