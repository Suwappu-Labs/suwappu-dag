...
**Status:** Ratified 2026-05-15 — Option A (multi-anchor scan in `decide_slot`) landed; paper-side amendment in [suwappu-papers#2](https://github.com/suwappu/suwappu-papers/pulls) (pending)
**Owner:** consensus
**Date:** 2026-05-15
**Tracking:** [#35](https://github.com/suwappu/suwappu-dag/issues/35) (closed by [#44](https://github.com/suwappu/suwappu-dag/pull/44), test-side mitigation) → [#45](https://github.com/suwappu/suwappu-dag/issues/45) (consensus-side fix in this IQ)
