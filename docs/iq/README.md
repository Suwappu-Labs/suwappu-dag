...
| [IQ-014](./IQ-014-machine-checked-invariant-proofs.md) | Machine-checked obligations for Theorem 2 + LTP soundness (formal-verification parity vs BTX) | Proptests only (10k-case exit gates); no machine-checked artifacts | Recommendation, pending sign-off |
