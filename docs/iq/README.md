...
| [IQ-008](./IQ-008-bounded-retention-and-checkpoint-sync.md) | Bounded DAG retention (consensus-anchored GC), durable commit log, checkpoint-anchored joiner sync (`/goal` A6 + A7) | DAG-S34, in progress on `claude/kasper-research-n9i4ct` | Recommendation, pending consensus-team sign-off |
